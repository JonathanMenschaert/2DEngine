...
#include "Time.h"
dae::MoveCommand::MoveCommand(GameObject* pGameObj, float speed, const glm::vec2& direction)
...
{
	auto pTransform{ m_pGameObject->GetComponent<TransformComponent>().lock() };
