...
void load()
{
	...
	dae::SceneManager::GetInstance().AddScene("SingleLevel2", dae::SingleThree::LoadScene);
	...
	dae::SceneManager::GetInstance().AddScene("CoopLevel2", dae::CoopThree::LoadScene);
	...
	dae::SceneManager::GetInstance().AddScene("VersusLevel2", dae::VersusTwo::LoadScene);
